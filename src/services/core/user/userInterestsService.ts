...
export class UserInterestsService {
  ...
  static async syncLocalInterests(userId: string, localInterests: string[]): Promise<string[]> {
    try {
      ...
      dbLogger.error('Error in syncLocalInterests', error instanceof Error ? error : undefined, {
        userId,
        metadata: { localInterestCount: localInterests.length },
      })
  ...
  static setLocalInterests(interests: string[]): void {
    try {
      ...
      dbLogger.error('Error setting local interests', error instanceof Error ? error : undefined, {
