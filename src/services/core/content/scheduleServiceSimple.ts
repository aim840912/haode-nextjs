...
export class ScheduleServiceSimple implements ScheduleService {
  ...
  async updateSchedule(
    ...
    try {
      ...
      if (scheduleData.specialOffer !== undefined)
        updateData.special_offer = scheduleData.specialOffer || null
...
// 建立並匯出服務實例
export const scheduleServiceSimple = new ScheduleServiceSimple()
