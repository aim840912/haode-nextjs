      ...
      <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50 dark:from-slate-900 dark:to-slate-800 flex items-center justify-center py-12 px-4">
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300">密碼重設連結已發送至您的信箱</p>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8">
            <div className="text-center space-y-4">
              <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 rounded-lg p-4">
                ...
                <p className="text-green-800 dark:text-green-300 font-medium">重設郵件已發送到</p>
                <p className="text-green-700 dark:text-green-400 text-sm break-all">{email}</p>
              </div>
            ...
            <div className="mt-6 space-y-3">
              <button
                ...
                className="w-full bg-amber-900 dark:bg-amber-800 text-white py-3 px-4 rounded-lg font-semibold hover:bg-amber-800 dark:hover:bg-amber-700 focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 transition-colors"
              >
                重新發送郵件
              </button>
              ...
              <Link
                href="/login"
                className="block w-full text-center py-3 px-4 border border-gray-300 dark:border-slate-600 rounded-lg text-gray-700 dark:text-gray-300 font-medium hover:bg-gray-50 dark:hover:bg-slate-700 focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 transition-colors"
              >
                返回登入
              </Link>
            </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50 dark:from-slate-900 dark:to-slate-800 flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300">輸入您的電子郵件，我們將發送重設連結</p>
        </div>
