...
import { BasicInfoSection } from '@/components/admin/location-form/BasicInfoSection'
import { BusinessHoursSection } from '@/components/admin/location-form/BusinessHoursSection'
import { FeaturesSection } from '@/components/admin/location-form/FeaturesSection'
import { ImageUploadSection } from '@/components/admin/location-form/ImageUploadSection'
import { SpecialtiesSection } from '@/components/admin/location-form/SpecialtiesSection'
import { TransportSection } from '@/components/admin/location-form/TransportSection'
