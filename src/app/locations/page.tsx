        ...
        {storeLocations.length === 0 ? (
          <div className="text-center py-12">
            <div className="mb-4 flex justify-center">
              ...
              >
                <path
                  ...
                  strokeWidth={1.5}
                  d="M3 21h18M3 10h18M3 7l9-4 9 4M5 21V10.85M19 21V10.85M9 21v-4a2 2 0 012-2h2a2 2 0 012 2v4"
                />
              </svg>
            </div>
            ...
            {user && user.role === 'admin' && (
              <a
                href="/admin/locations/add"
                className="inline-flex items-center px-6 py-3 bg-amber-900 text-white rounded-lg hover:bg-amber-800 transition-colors"
              >
                新增第一間門市
              </a>
            )}
