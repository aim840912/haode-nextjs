        ...
        if (currentNews) {
          ...
          if (allNewsResponse.ok) {
            ...
            const related = allNews
              .filter((item: NewsItem) => item.category === currentNews.category && item.id !== id)
              .slice(0, 3)
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/news" className="text-amber-900 hover:text-amber-800 font-medium">
            回到新聞列表
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b">
        <div className="max-w-4xl mx-auto px-6 py-4">
          <Breadcrumbs items={createNewsBreadcrumbs(newsItem.title)} enableStructuredData={true} />
        </div>
      </div>
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="p-8">
            ...
            <div className="flex flex-wrap items-center gap-4 mb-6 pb-6 border-b border-gray-200">
              ...
              <span className="text-gray-600 text-sm">{formatDate(newsItem.publishedAt)}</span>
              <span className="text-gray-600 text-sm">作者：{newsItem.author}</span>
            </div>
            ...
            <div className="bg-amber-50 border-l-4 border-amber-400 p-4 mb-8">
              <p className="text-lg text-gray-700 leading-relaxed">{newsItem.summary}</p>
            </div>
