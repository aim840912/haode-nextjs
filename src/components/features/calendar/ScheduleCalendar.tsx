...
export function ScheduleCalendar({
  ...
  const { events, statistics, loading, error, refreshData, statusFilter, setStatusFilter } =
    useScheduleCalendar()
    ...
    <div className={`schedule-calendar ${className}`}>
      ...
      <div className="mb-6 flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
        ...
        <div className="flex gap-2">
          <button
            onClick={() =>
              setSelectedView(selectedView === 'dayGridMonth' ? 'listWeek' : 'dayGridMonth')
            }
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <span className="text-2xl">📅</span>
                  <strong className="ml-2">{formatDateTime(selectedEvent.start).date}</strong>
                </div>

                <div>
                  <span className="text-2xl">⏰</span>
                  <strong className="ml-2">{formatDateTime(selectedEvent.start).time}</strong>
                </div>
                ...
                {selectedEvent.extendedProps.weatherNote && (
                  <div>
                    ...
                    <div className="mt-1 ml-8">{selectedEvent.extendedProps.weatherNote}</div>
                  </div>
                )}
                ...
                {selectedEvent.extendedProps.description && (
                  <div>
                    ...
                    <div className="mt-1 ml-8">{selectedEvent.extendedProps.description}</div>
                  </div>
                )}
                ...
                <div>
                  ...
                  <div className="mt-1 ml-8">{selectedEvent.extendedProps.contact}</div>
                </div>
              </div>
