      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1 min-w-0">
              <h3 className="text-lg font-semibold text-gray-900 truncate mb-2">{result.title}</h3>
              <p className="text-gray-600 text-sm line-clamp-2 mb-3">{result.description}</p>
            ...
            <div className="flex-shrink-0 text-right">
              ...
              {result.rating && (
                <div className="text-sm text-yellow-600">⭐ {result.rating.toFixed(1)}</div>
              )}
            </div>
          </div>
        </div>
          ...
          {isLoading ? (
            ...
            <>
              ...
              {searchResponse.processingTime && (
                <span className="ml-2">(耗時 {searchResponse.processingTime}ms)</span>
              )}
            </>
          ) : null}
        </div>
