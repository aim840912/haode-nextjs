      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50">
          <div className="text-center max-w-md mx-auto p-6">
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-2">頁面載入發生錯誤</h2>
        ...
        fallback || (
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 m-4">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-red-800">組件載入失敗</h3>
                <p className="text-sm text-red-700 mt-1">此區塊暫時無法顯示，請重新整理頁面。</p>
              </div>
            </div>
          </div>
        )
