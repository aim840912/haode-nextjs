        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/products" className="text-amber-100 hover:text-white transition-colors">
                  產品介紹
                </Link>
              </li>
              <li>
                <Link href="/farm-tour" className="text-amber-100 hover:text-white transition-colors">
                  農場參觀
                </Link>
              </li>
              <li>
                <Link href="/schedule" className="text-amber-100 hover:text-white transition-colors">
                  擺攤行程
                </Link>
              </li>
              <li>
                <Link href="/locations" className="text-amber-100 hover:text-white transition-colors">
                  門市據點
                </Link>
              </li>
              <li>
